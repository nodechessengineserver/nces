...
class Bracket {    
    ...
    savebracketcallback(fcstate:FileChooserState){
    ...
    bracketloadedcallback(ajaxasset:AjaxAsset){
    ...
    loadbracketcallback(fcstate:FileChooserState){
        let fullpath=fcstate.fullpath()          
        let ajaxasset=new AjaxAsset({
            action:"readtextfile",
            path:fullpath
    ...
    createElement():HTMLElement_{        
        ...
        let filechooser=new FileChooser("bracketfilechooser",Globals.gui.dialogroot).
