...
var AjaxAsset = /** @class */ (function () {
    function AjaxAsset(_reqjson) {
        this.url = "/ajax";
        this.isready = false;
        this.reqjson = _reqjson;
    }
    AjaxAsset.prototype.load = function () {
        var _this = this;
        var body = JSON.stringify(this.reqjson);
    ...
    AjaxAsset.prototype.ready = function () {
        return this.isready;
    };
    return AjaxAsset;
}());
...
(function (Misc) {
    ...
    Misc.Timer = Timer;
    var JsonSerializableState = /** @class */ (function () {
        function JsonSerializableState() {
        }
        JsonSerializableState.prototype.fromJsonText = function (jsontext) {
            this.fromJson(JSON.parse(jsontext));
        };
        return JsonSerializableState;
    }());
    Misc.JsonSerializableState = JsonSerializableState;
    function roughlyEqualStrings(a, b) {
        return a.toLowerCase() == b.toLowerCase();
    }
    Misc.roughlyEqualStrings = roughlyEqualStrings;
    function updateObjectWith(obj, update) {
    ...
    Misc.updateObjectWith = updateObjectWith;
...
(function (Analysis) {
    var ThinkingOutput = /** @class */ (function () {
        function ThinkingOutput(_prot, _variant) {
            ...
            this.score = 0;
            this.depth = 0;
            this.bestmovereceived = false;
            this.prot = _prot;
            this.variant = _variant;
        }
        ThinkingOutput.prototype.scoreFormatted = function () {
            return (this.scoremate ? "#" : "") + this.score;
        };
        ThinkingOutput.prototype.scoreNumerical = function () {
    ...
    var Analyzer = /** @class */ (function () {
        ...
        Analyzer.prototype.waitbestmove = function (callback) {
        ...
        Analyzer.prototype.analyze = function (switchenabled) {
            if (switchenabled === void 0) { switchenabled = true; }
            this.thinkingoutput.bestmovereceived = false;
            if (Globals.gui.appconfig.switchToEngineTab && switchenabled)
        ...
        Analyzer.prototype.makeanalyzedmove = function () {
            ...
            if (algeb != "") {
                var m = Globals.wboard.algebToMove(algeb);
                var fenbefore = Globals.wboard.reportFen();
                Globals.wboard.makeMove(m);
                var fenafter = Globals.wboard.reportFen();
                if (fenafter == fenbefore) {
                    ...
                    var truem = Globals.wboard.algebToMove(truealgeb);
        ...
        Analyzer.prototype.issueneural = function (command) {
            var em = new EngineMessage().
                _action("issueneural").
                _command(command);
            this.sendem(em, this.connectid);
        };
        Analyzer.prototype.issueneuralJson = function (commandjson) {
...
var Book = /** @class */ (function () {
    ...
    Book.prototype.fromJsonText = function (jsontext) {
        this.parseObj(JSON.parse(jsontext));
    };
    Book.prototype.src = function () {
        return JSON.stringify(this);
    };
    Book.prototype.store = function () {
        var storeid = this.storeid();
        localStorage.setItem(storeid, this.src());
    };
...
(function (Config) {
    Config.appConfig = {
        handle: "myhandle",
        switchToEngineTab: true,
        onGameLoad: {
            autoStartEngine: false,
            autoStartEngineTimeout: 3000,
            forwardMoves: 0
        }
    };
    Config.MATE_SCORE = 10000;
...
var HTMLElement_ = /** @class */ (function () {
    ...
    HTMLElement_.prototype.focus = function () {
        this.e.focus();
    };
    HTMLElement_.prototype.blur = function () {
        this.e.blur();
    };
    ...
    HTMLElement_.prototype.marginBottom = function (marginbottom) {
        this.e.style.marginBottom = marginbottom;
        return this;
    };
    HTMLElement_.prototype.marginBottomPx = function (marginbottompx) {
    ...
    HTMLElement_.prototype.marginRight = function (marginright) {
        this.e.style.marginRight = marginright;
        return this;
    };
    HTMLElement_.prototype.marginRightPx = function (marginrightpx) {
...
var HTMLInputElement_ = /** @class */ (function (_super) {
    ...
    HTMLInputElement_.prototype.setEnterCallback = function (entercallback) {
        this.entercallback = entercallback;
        return this;
    };
    HTMLInputElement_.prototype.moveEditCur = function (dir) {
        ...
        this.editCur += dir;
        if (this.editCur >= this.editlist.length)
            this.editCur = 0;
        else if (this.editCur < 0)
            this.editCur = this.editlist.length - 1;
        this.setText(this.editlist[this.editCur]);
    };
    HTMLInputElement_.prototype.keyup = function (e) {
        //console.log(e.code)
        if (e.code == "Enter") {
...
var PaddedTd = /** @class */ (function (_super) {
    ...
    function PaddedTd(paddingpx) {
        if (paddingpx === void 0) { paddingpx = 3; }
        var _this = _super.call(this) || this;
        _this.paddingPx(paddingpx);
        return _this;
    }
    return PaddedTd;
}(HTMLTableColElement_));
var FileChooserState = /** @class */ (function (_super) {
    __extends(FileChooserState, _super);
    function FileChooserState() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.dirpathl = ["C:"];
        _this.name = "default";
        _this.action = "";
    ...
    FileChooserState.prototype.dirpath = function () {
        return this.dirpathl.join("/") + "/";
    };
    FileChooserState.prototype.fullpath = function () {
        return this.dirpath() + this.name;
    };
    FileChooserState.prototype.pathInfo = function (MAX) {
    ...
    FileChooserState.prototype.fromJson = function (json) {
        this.dirpathl = json.dirpathl;
        this.name = json.name;
        return this;
    };
    FileChooserState.prototype.clone = function () {
        var fc = new FileChooserState();
        fc.fromJsonText(JSON.stringify(this));
        return fc;
    };
    return FileChooserState;
}(Misc.JsonSerializableState));
var FileChooser = /** @class */ (function (_super) {
    __extends(FileChooser, _super);
    function FileChooser(_id, _dialogroot) {
        var _this = _super.call(this) || this;
        _this.opendialog = null;
        _this.state = new FileChooserState();
        _this.savecallback = null;
        _this.loadcallback = null;
        _this.deletecallback = null;
        _this.id = _id;
        FileChooser.registry[_id] = _this;
        _this.dialogroot = _dialogroot;
        _this.load();
        return _this;
    }
    FileChooser.prototype.hide = function () {
        if (this.opendialog != null)
            this.opendialog.hide();
        this.opendialog = null;
    };
    FileChooser.prototype.hideAll = function () {
        for (var id in FileChooser.registry) {
            var fc = FileChooser.registry[id];
            fc.hide();
        }
    };
    FileChooser.prototype.dirSelected = function (fcstate) {
        this.hideAll();
        if ((fcstate.action == "select") || (fcstate.action == "selectfile"))
            this.state.dirpathl = fcstate.dirpathl;
        if (fcstate.action == "selectfile")
            this.state.name = fcstate.name;
        this.save();
        this.build();
    };
    FileChooser.prototype.choosedrivebuttonpressed = function (e) {
        var drivename = prompt("Enter drive name !");
    ...
    FileChooser.prototype.choosedirbuttonpressed = function (e) {
        var shouldopen = this.opendialog == null;
        this.hideAll();
        if (shouldopen) {
            this.opendialog = new FileDialogWindow(this.id + "_dirdialog").
                ...
                build();
            this.dialogroot.html("").appendChild(this.opendialog);
        }
    };
    FileChooser.prototype.actualize = function () {
        this.state.name = this.nameinput.getText();
        this.save();
    };
    FileChooser.prototype.savebuttonpressed = function (e) {
        this.actualize();
        this.savecallback(this.state);
    };
    FileChooser.prototype.setSaveCallback = function (_savecallback) {
        this.savecallback = _savecallback;
        return this;
    };
    FileChooser.prototype.loadbuttonpressed = function (e) {
        this.actualize();
        this.loadcallback(this.state);
    };
    FileChooser.prototype.setLoadCallback = function (_loadcallback) {
        this.loadcallback = _loadcallback;
        return this;
    };
    FileChooser.prototype.deletebuttonpressed = function (e) {
        this.actualize();
        this.deletecallback(this.state);
    };
    FileChooser.prototype.setDeleteCallback = function (_deletecallback) {
        this.deletecallback = _deletecallback;
        return this;
    };
    FileChooser.prototype.load = function () {
        var stored = localStorage.getItem(this.id);
        if (Misc.isDefined(stored)) {
            this.state.fromJsonText(stored);
        }
    };
    FileChooser.prototype.save = function () {
        localStorage.setItem(this.id, JSON.stringify(this.state));
    };
    FileChooser.prototype.build = function () {
        this.
        ...
        var choosedrivebutton = new HTMLButtonElement_().
            value(this.state.dirpathl[0]).
            onmousedown(this.choosedrivebuttonpressed.bind(this)).
            widthPx(50);
        var choosedirbutton = new HTMLButtonElement_().
            value("...").
        ...
        var loadbutton = new HTMLButtonElement_().
            value("Load").
        ...
        if (this.savecallback != null)
            tr.appendChild(new PaddedTd().appendChild(savebutton));
        if (this.loadcallback != null)
            tr.appendChild(new PaddedTd().appendChild(loadbutton));
        if (this.deletecallback != null)
            tr.appendChild(new PaddedTd().appendChild(deletebutton));
        this.appendChild(tr);
        this.dirinput.setText(this.state.pathInfo());
        this.nameinput.setText(this.state.name);
        return this;
    };
    FileChooser.registry = {};
    return FileChooser;
}(HTMLTableElement_));
var FileDialogWindowState = /** @class */ (function () {
    function FileDialogWindowState() {
        this.x = 0;
        this.y = 0;
    }
    return FileDialogWindowState;
}());
var FileDialogWindow = /** @class */ (function (_super) {
    __extends(FileDialogWindow, _super);
    function FileDialogWindow(_id) {
        var _this = _super.call(this) || this;
        _this.title = "";
        _this.state = new FileDialogWindowState();
        _this.fcstate = new FileChooserState();
        _this.w = 400;
        _this.h = 400;
        _this.dragunderway = false;
        _this.id = _id;
        _this.position("absolute").zIndexNumber(10000);
        _this.topbardiv = new HTMLDivElement_().position("absolute");
        _this.contentdiv = new HTMLDivElement_().position("absolute");
        _this.bottombardiv = new HTMLDivElement_().position("absolute");
        return _this;
    }
    FileDialogWindow.prototype.windowdragstart = function (e) {
        e.preventDefault();
        var me = e;
        this.dragstart = new Vectors.ScreenVector(me.clientX, me.clientY);
        this.dragunderway = true;
    };
    FileDialogWindow.prototype.windowmouseout = function (e) {
        this.windowmousemove(e);
        this.windowmouseup(null);
        this.dragunderway = false;
    };
    FileDialogWindow.prototype.windowmousemove = function (e) {
        var me = e;
    ...
    FileDialogWindow.prototype.windowmouseup = function (e) {
        if (this.dragunderway) {
            this.dragunderway = false;
    ...
    FileDialogWindow.prototype.load = function () {
        var stored = localStorage.getItem(this.id);
        if (Misc.isDefined(stored))
            this.state = JSON.parse(stored);
    };
    FileDialogWindow.prototype.save = function () {
        localStorage.setItem(this.id, JSON.stringify(this.state));
    };
    FileDialogWindow.prototype.onDirectorySelected = function () {
    };
    FileDialogWindow.prototype.onDirectoryError = function () {
    };
    FileDialogWindow.prototype.selectbuttonpressed = function (e) {
        this.fcstate.action = "select";
        this.dirselectedcallback(this.fcstate);
    };
    FileDialogWindow.prototype.cancelbuttonpressed = function (e) {
        this.fcstate.action = "cancel";
        this.dirselectedcallback(this.fcstate);
    };
    FileDialogWindow.prototype.onCreateDir = function () {
        var r = this.createdirajaxasset.resjson;
        this.contentdiv.
            html("").
            appendChild(this.createListContent(r.files));
    };
    FileDialogWindow.prototype.onCreateDirError = function () {
    };
    FileDialogWindow.prototype.createbuttonpressed = function (e) {
    ...
    FileDialogWindow.prototype.totalHeight = function () {
        return this.h + FileDialogWindow.BAR_WIDTH + FileDialogWindow.BOTTOM_BAR_WIDTH;
    };
    FileDialogWindow.prototype.build = function () {
        this.load();
        this.
            html("").
            topPx(this.state.y).
            ...
            opacityNumber(0.9);
        var pathinfo = this.fcstate.pathInfo();
        this.topbardiv.
    ...
    FileDialogWindow.prototype.loadDir = function () {
    ...
    FileDialogWindow.prototype.createListContent = function (dirlist) {
        var _this = this;
        var list = new HTMLDivElement_();
        var dirlistarray = dirlist;
        dirlistarray.sort(function (a, b) {
            if (a.isdir && !b.isdir)
                return -1;
            if (!a.isdir && b.isdir)
                return 1;
        ...
        var i = 0;
        dirlistarray.map(function (fstats) {
            var stats = fstats.stats;
            var bcol = "#efefef";
            if (fstats.isdir)
                bcol = ((i % 2) == 0) ? "#ffffcf" : "#ffffbf";
            if (fstats.isfile)
                bcol = ((i % 2) == 0) ? "#efefef" : "#dfdfdf";
            if (!fstats.ok)
                bcol = ((i % 2) == 0) ? "#ffdfdf" : "#ffcfcf";
            var itemdiv = new HTMLDivElement_().
                paddingPx(FileDialogWindow.PADDING).
                cursor("pointer").
                ...
                addEventListener("mousedown", _this.dirItemClicked.bind(_this, fstats));
            list.appendChild(itemdiv);
            i++;
        });
        return list;
    };
    FileDialogWindow.prototype.dirItemClicked = function (fstats, e) {
    ...
    FileDialogWindow.prototype.onListDir = function () {
        var r = this.listdirajaxasset.resjson;
        this.contentdiv.
            html("").
            appendChild(this.createListContent(r.files));
    };
    FileDialogWindow.prototype.onListDirError = function () {
    };
    FileDialogWindow.prototype.hide = function () {
        this.html("").widthPx(0).heightPx(0);
        return this;
    };
    FileDialogWindow.prototype.setTitle = function (_title) {
        this.title = _title;
        return this;
    };
    FileDialogWindow.prototype.setFileChooserState = function (_fcstate) {
        this.fcstate = _fcstate;
        return this;
    };
    FileDialogWindow.prototype.setDirSelectedCallback = function (_dirselectedcallback) {
        this.dirselectedcallback = _dirselectedcallback;
        return this;
    };
    FileDialogWindow.BAR_WIDTH = 36;
    FileDialogWindow.BOTTOM_BAR_WIDTH = 40;
    FileDialogWindow.PADDING = 3;
    FileDialogWindow.OUTER_MARGIN = 5;
    FileDialogWindow.MAX_WINDOW_Y = 300;
    FileDialogWindow.MAX_WINDOW_X = 1000;
...
var Bracket = /** @class */ (function () {
    ...
    Bracket.prototype.savebracketcallback = function (fcstate) {
        var fullpath = fcstate.fullpath();
        var src = this.src();
        var ajaxasset = new AjaxAsset({
    ...
    Bracket.prototype.bracketloadedcallback = function (ajaxasset) {
        var result = ajaxasset.resjson;
        if (!result.error) {
            Globals.gui.srctext.setText(result.content);
            Globals.gui.tabs.setSelected("src");
        }
    };
    Bracket.prototype.loadbracketcallback = function (fcstate) {
        var fullpath = fcstate.fullpath();
        var ajaxasset = new AjaxAsset({
            action: "readtextfile",
            path: fullpath
        ...
        new AssetLoader().
            add(ajaxasset).
            setcallback(this.bracketloadedcallback.bind(this, ajaxasset)).
            load();
    };
    Bracket.prototype.createElement = function () {
        ...
        var filechooser = new FileChooser("bracketfilechooser", Globals.gui.dialogroot).
            setSaveCallback(this.savebracketcallback.bind(this)).
            setLoadCallback(this.loadbracketcallback.bind(this)).
            build();
    ...
    Bracket.prototype.src = function () {
        return JSON.stringify(this.pairingstateregistry, null, 1);
    };
...
var GUI = /** @class */ (function () {
    ...
    GUI.prototype.nlog = function (li) {
        this.nlogger.log(li);
        var html = this.nlogger.reportHtml();
    ...
    GUI.prototype.createEngineControlPanel = function () {
        ...
        var anchorbutton = new HTMLButtonElement_().
            value("A").
            onmousedown(this.anchorbuttonpressed.bind(this));
        var restorebutton = new HTMLButtonElement_().
            value("<-").
    ...
    GUI.prototype.appConfigText = function () {
        return JSON.stringify(this.appconfig, null, 1);
    };
    GUI.prototype.createConfigDiv = function () {
        var stored = localStorage.getItem("appconfig");
        if (Misc.isDefined(stored)) {
        ...
        this.configtext.
            widthPx(Config.PREFERRED_TAB_SIZE - 25).
            heightPx(Config.TOTAL_BOARD_HEIGHT - 65);
        var configapplybutton = new HTMLButtonElement_().
            value("Apply").
    ...
    GUI.prototype.createBookDiv = function () {
        ...
        var exportbookbutton = new HTMLButtonElement_().
            value("Export").
            onmousedown(this.exportbookbuttonpressed.bind(this));
        var importbookbutton = new HTMLButtonElement_().
            value("Import").
            onmousedown(this.importbookbuttonpressed.bind(this));
        var filechooser = new FileChooser("bookfilechooser_" + this.state._variant, this.dialogroot).
    ...
    GUI.prototype.createNcontrolDiv = function () {
        this.ncontroldiv = new HTMLDivElement_();
        var issuelabel = new HTMLLabelElement_().setText("Enter neural command : ");
        this.nissuetext = new HTMLInputElement_();
        this.nissuetext.
            setEnterCallback(this.neuralissuebuttonpressed.bind(this)).
            widthPx(100);
        var neuralissuebutton = new HTMLButtonElement_().
            value("Issue").
            onmousedown(this.neuralissuebuttonpressed.bind(this));
        var moveoncebutton = new HTMLButtonElement_().
            value("Move once").
            onmousedown(this.moveonce.bind(this));
        var gameoncebutton = new HTMLButtonElement_().
            value("Game once").
            onmousedown(this.gameonce.bind(this));
        var trainbutton = new HTMLButtonElement_().
            value("Train").
            onmousedown(this.train.bind(this));
        var stoptrainbutton = new HTMLButtonElement_().
            value("Stop").
            onmousedown(this.stoptrain.bind(this));
        var testneuralbutton = new HTMLButtonElement_().
            value("Test").
            onmousedown(this.testneural.bind(this));
        var reloadneuralbutton = new HTMLButtonElement_().
            value("Reload").
    ...
    GUI.prototype.draw = function () {
        ...
        setTimeout((function (e) {
            ...
            _this.root.appendChild(_this.dialogroot);
            ...
            setTimeout(_this.systemWatch.bind(_this), 1000);
        }).bind(this), 0);
        //////////////////////////////////////////////////////////
    };
    GUI.prototype.systemWatch = function (e) {
        var pastetext = this.pastetext.getText();
        if (pastetext != "") {
    ...
    GUI.prototype.importbookbuttonpressed = function (e) {
        var src = this.srctext.getText();
        this.book.fromJsonText(src);
        this.book.store();
        Globals.wboard.showBookPage();
    };
    GUI.prototype.exportbookbuttonpressed = function (e) {
    ...
    GUI.prototype.anchorbuttonpressed = function (e) {
        Globals.wboard.latestpgn = Globals.wboard.reportPgn();
    };
    GUI.prototype.restorebuttonpressed = function (e) {
    ...
    GUI.prototype.ongameload = function (lg) {
        ...
        var ogl = this.appconfig.onGameLoad;
        var fw = ogl.forwardMoves;
        if (fw) {
            for (var i = 0; i < fw; i++)
                Globals.wboard.doforward();
        }
        if (ogl.autoStartEngine) {
            setTimeout(function (e) { return _this.analyzer.analyze(); }, ogl.autoStartEngineTimeout);
        }
    };
    ...
    GUI.prototype.loadLichessGameById = function (gameid) {
        var lg = new LichessGame(gameid);
    ...
    GUI.prototype.savebookcallback = function (fcstate) {
        var fullpath = fcstate.fullpath();
        var src = this.book.src();
        var ajaxasset = new AjaxAsset({
            action: "writetextfile",
            path: fullpath,
            content: src
    ...
    GUI.prototype.bookloadedcallback = function (ajaxasset) {
        var result = ajaxasset.resjson;
        if (!result.error) {
    ...
    GUI.prototype.loadbookcallback = function (fcstate) {
        var fullpath = fcstate.fullpath();
        var ajaxasset = new AjaxAsset({
            action: "readtextfile",
            path: fullpath
    ...
    GUI.prototype.configapplybuttonpressed = function (e) {
        var jsontext = this.configtext.getText();
        try {
    ...
    GUI.prototype.neuralissuebuttonpressed = function (e) {
        var command = this.nissuetext.getText();
        this.nissuetext.setText("");
        this.analyzer.issueneural(command);
    };
    GUI.prototype.sendfens = function (e) {
        var fens = Globals.wboard.legalFens();
        if (fens.length < 1)
            return false;
        var json = { action: "playmove", fens: fens };
        var jsonstr = JSON.stringify(json);
        this.analyzer.issueneural(jsonstr);
        return true;
    };
    GUI.prototype.maketrainmove = function () {
        this.analyzer.stopanalysis();
        var evals = this.getEvals();
        var fen = Globals.wboard.reportFen();
        var to = this.analyzer.thinkingoutput;
        var score = to.scoreNumerical();
        var san = this.analyzer.makeanalyzedmove();
        evals[fen] = {
            san: san,
            score: score,
            depth: to.depth
    ...
    GUI.prototype.starttrainmove = function () {
        if (!this.trainon)
            return;
        this.analyzer.analyze(false);
        setTimeout(this.maketrainmove.bind(this), 500);
    };
    GUI.prototype.train = function (e) {
        Globals.wboard.doreset();
        this.trainon = true;
        this.starttrainmove();
    };
    GUI.prototype.stoptrain = function (e) {
        this.trainon = false;
        this.saveEvals();
    };
    GUI.prototype.makeneuralsan = function (json) {
        var san = json.san;
        Globals.wboard.domakeSanMove(san);
        if (this.moveonceon) {
            this.moveonceon = false;
    ...
    GUI.prototype.loadEvals = function () {
    ...
    GUI.prototype.getEvals = function () {
        if (this.evals == undefined)
            this.evals = {};
        return this.evals;
    };
    GUI.prototype.saveEvalsDone = function () {
        this.analyzer.issueneural(JSON.stringify({
            action: "epoch",
            n: 3
        }));
    };
    GUI.prototype.saveEvals = function () {
        var saveevalsasset = new AjaxAsset({
            action: "writetextfile",
            path: "evals.json",
    ...
    GUI.prototype.moveonce = function (e) {
        this.trainon = true;
        this.moveonceon = true;
        this.starttrainmove();
    };
    GUI.prototype.gameonce = function (e) {
        this.trainon = true;
        this.gameonceon = true;
        this.train(null);
    };
    GUI.prototype.testneural = function (e) {
        this.analyzer.issueneuralJson({ action: "test" });
    };
    GUI.prototype.reloadneural = function (e) {
...
var wBoard = /** @class */ (function (_super) {
    ...
    wBoard.prototype.legalFens = function () {
        var _this = this;
        var sans = this.sortedLegalSanList().split("\n");
        if (sans[0] == "")
            return [];
        var fens = sans.map(function (san) {
            _this.makeSanMove(san);
            var result = { san: san, fen: _this.reportFen() };
            _this.back();
            return result;
        });
        return fens;
    ...
    wBoard.prototype.flipByHandle = function () {
        var appconfig = Globals.gui.appconfig;
        var handle = appconfig.handle;
        var white = this.getPgnHeader("White");
        var black = this.getPgnHeader("Black");
        if (handle != undefined) {
            if (Misc.roughlyEqualStrings(handle, white))
                this.flip = 0;
            if (Misc.roughlyEqualStrings(handle, black))
                this.flip = 2;
        }
    };
    wBoard.prototype.setUpGame = function () {
        this.latestpgn = this.reportPgn();
        this.flipByHandle();
    };
